...
6. Keep optional graph residual diagnostics as structural analysis rather than performance ranking metrics.
7. Use the signal to decide whether to pursue event-aware, retrieval-based, or graph-contribution follow-up work.
...
| R005 | Optional spatial residual diagnostics | SD_5min_full | edge residual correlation / smoothness | TODO | Structural signal only; not a performance metric. |
