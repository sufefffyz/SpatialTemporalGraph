...
| R011 | M4 | Compare moving-average and FFT low-pass decomposition diagnostics | 10 non-PropMLP baselines | SD test | per-method low/high MAE, W1, residual metrics, method deltas | MUST | TODO | Run after pushing scripts; expected output `results/server_sd_baselines_20260516_decomp_method_comparison`. |
