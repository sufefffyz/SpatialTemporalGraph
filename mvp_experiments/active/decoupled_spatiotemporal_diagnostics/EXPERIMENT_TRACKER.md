...
| R009 | M2 | Recompute H1-H12 BasicTS-style test metrics and plots | 10 non-PropMLP baselines | SD test | MAE, RMSE, MAPE, WAPE by horizon | MUST | DONE | Output: `results/server_sd_baselines_20260515_horizon_test_results`; copied locally under `outputs/server_sd_baselines_20260515_horizon_test_results`. |
| R010 | M2 | Recompute H1-H12 decoupled diagnostics and plots | 10 non-PropMLP baselines | SD test | low/high MAE, W1, peak MAE, residual bias/corr/Dirichlet | MUST | DONE | Output: `results/server_sd_baselines_20260516_decoupled_horizon_diagnostics`; copied locally under `outputs/server_sd_baselines_20260516_decoupled_horizon_diagnostics`. |
| R011 | M4 | Compare moving-average and FFT low-pass decomposition diagnostics | 10 non-PropMLP baselines | SD test | per-method low/high MAE, W1, residual metrics, method deltas | MUST | DONE | Output: `results/server_sd_baselines_20260516_decomp_method_comparison`; copied locally under `outputs/server_sd_baselines_20260516_decomp_method_comparison`. |
