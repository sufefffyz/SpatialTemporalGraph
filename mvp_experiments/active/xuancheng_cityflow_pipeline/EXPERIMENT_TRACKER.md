...
| R004 | `run_server_xuancheng_month.sh` with `DURATION=86400 BUCKET_SECONDS=60` | RUNNING | `/data/yuzhang_fei/xuancheng_cityflow/road_agg_30d_fixed_time/` | Screen `xuancheng_30d_fixed_time`; logs in `/data/yuzhang_fei/xuancheng_cityflow/logs/road_agg_30d_fixed_time_latest/`; full official 30-day release, fixed-time signal mode, 1-min road tensors. |
