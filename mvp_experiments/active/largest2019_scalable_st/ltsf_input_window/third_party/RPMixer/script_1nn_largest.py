...
def main(data_name, method_name, n_worker):
    ...
    pred_valid = dataset_valid.inverse_transform(pred_valid)
    gtrue_valid = dataset_valid.inverse_transform(gtrue_valid)
    pred_test = dataset_test.inverse_transform(pred_test)
    gtrue_test = dataset_test.inverse_transform(gtrue_test)
