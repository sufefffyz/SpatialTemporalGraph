...
GPU="${1:-1}"
RUN_TAG="${2:-osrm_gaussian_global_gwnet_adaptive_20260513}"
PROJECT="${WANDB_PROJECT:-adaptive_threshold_dynamic_weight}"

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)"
BASICTS_DIR="${REPO_ROOT}/BasicTS"
MODEL="gwnet_adaptive"
MODEL_NAME="GraphWaveNetAdaptive"
CFG="baselines/GWNet/SD_osrm_gaussian_global_adaptive.py"
