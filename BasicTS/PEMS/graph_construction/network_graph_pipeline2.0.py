...
def phase2_assign_freeways_ref_only(
    ...
    link_to_fwy = {}        # edge_key -> fwy_number (int)
    link_to_ref = {}         # edge_key -> original ref string
    ...
    for _, row in mainline_edges.iterrows():
        ...
        if numbers:
            ...
            link_to_fwy[ek] = fwy_num
            link_to_ref[ek] = primary_ref
        else:
            no_ref_links.append({
                "edge_key": ek,
                "ref": ref,
    ...
    for ek, fwy_num in link_to_fwy.items():
        fwy_groups[fwy_num].append({
            "id": ek,
            "dir": None,
            "ref": link_to_ref.get(ek, ""),
        })
