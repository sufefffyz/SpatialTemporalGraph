...
CFG = EasyDict()
CFG.DESCRIPTION = "MTGNN on LargeST SD with learned adjacency"
CFG.GPU_NUM = 1
...
ckpt_name_parts = [DATA_NAME, str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)]
if RUN_TAG:
...
CFG.WANDB.GROUP = os.environ.get("WANDB_RUN_GROUP", "sd_baseline_mtgnn")
CFG.WANDB.TAGS = ["adaptive-threshold", "sd", "mtgnn", "baseline"]
