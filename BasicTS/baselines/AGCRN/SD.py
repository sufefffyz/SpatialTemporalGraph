...
CFG = EasyDict()
CFG.DESCRIPTION = "AGCRN on LargeST SD"
CFG.GPU_NUM = 1
...
CFG.WANDB.GROUP = os.environ.get("WANDB_RUN_GROUP", "sd_baseline_agcrn")
CFG.WANDB.TAGS = ["adaptive-threshold", "sd", "agcrn", "baseline"]
