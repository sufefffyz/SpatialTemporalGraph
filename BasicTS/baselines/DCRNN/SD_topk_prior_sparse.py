...
from .arch import SparseDCRNN


MODEL_ARCH = SparseDCRNN

CFG.DESCRIPTION = f"Sparse DCRNN fixed top-k prior graph on {DATA_NAME} ({GRAPH_TAG})"
...
CFG.WANDB.GROUP = os.environ.get("WANDB_RUN_GROUP", "sd_topk_prior_sparsedcrnn_fixed")
CFG.WANDB.TAGS = [
    "adaptive-threshold",
    "sd",
    "topk-prior",
