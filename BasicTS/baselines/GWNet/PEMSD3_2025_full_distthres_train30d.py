...
DATA_NAME = 'PEMSD3_2025_full_distthres'
...
CFG = EasyDict()
CFG.DESCRIPTION = 'PeMS MVP pilot on ' + DATA_NAME + ' (train30d)'
CFG.GPU_NUM = 1
...
CFG.WANDB.RUN_NAME = f'{MODEL_ARCH.__name__}_{DATA_NAME}_train30d'
CFG.WANDB.GROUP = DATA_NAME
CFG.WANDB.TAGS = ['pems-mvp', 'train30d']
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, 'train30d', str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
