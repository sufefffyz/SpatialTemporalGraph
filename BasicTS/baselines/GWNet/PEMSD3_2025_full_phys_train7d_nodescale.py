...
CFG = EasyDict()
CFG.DESCRIPTION = 'PeMS MVP pilot on ' + DATA_NAME + ' (train7d_nodescale)'
CFG.GPU_NUM = 1
...
CFG.WANDB.RUN_NAME = f'{MODEL_ARCH.__name__}_{DATA_NAME}_train7d_nodescale'
CFG.WANDB.GROUP = DATA_NAME
CFG.WANDB.TAGS = ['pems-mvp', 'train7d', 'nodescale']
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, 'train7d_nodescale', str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
