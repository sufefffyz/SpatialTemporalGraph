...
CFG = EasyDict()
CFG.DESCRIPTION = 'PeMS MVP pilot on ' + DATA_NAME + ' (adaptive_train7d_nodescale)'
CFG.GPU_NUM = 1
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, 'adaptive_train7d_nodescale', str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
