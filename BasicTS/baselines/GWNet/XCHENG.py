...
MODEL_PARAM = {
    ...
    "in_dim": 1,
    "out_dim": OUTPUT_LEN,
    "residual_channels": int(os.environ.get("BASICTS_GWNET_RESIDUAL_CHANNELS", "32")),
    "dilation_channels": int(os.environ.get("BASICTS_GWNET_DILATION_CHANNELS", "32")),
    "skip_channels": int(os.environ.get("BASICTS_GWNET_SKIP_CHANNELS", "256")),
    "end_channels": int(os.environ.get("BASICTS_GWNET_END_CHANNELS", "512")),
    "kernel_size": 2,
...
CFG = EasyDict()
CFG.DESCRIPTION = f"GraphWaveNet on {DATA_NAME}"
CFG.GPU_NUM = 1
...
CFG.TRAIN.OPTIM.PARAM = {
    "lr": float(os.environ.get("BASICTS_LR", "0.002")),
...
CFG.WANDB.RUN_NAME = os.environ.get("WANDB_NAME", f"GraphWaveNet_{DATA_NAME}_{RUN_TAG or 'baseline'}")
CFG.WANDB.GROUP = os.environ.get("WANDB_RUN_GROUP", "xuancheng_basicts_gwnet")
CFG.WANDB.TAGS = ["xuancheng", "cityflow", "gwnet", DATA_NAME]
