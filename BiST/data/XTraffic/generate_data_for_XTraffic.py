...
def generate_train_val_test(args):
    ...
    data, idx = generate_data_and_idx(df, x_offsets, y_offsets, args.tod, args.dow, args.moy)
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    np.savez_compressed(os.path.join('his_2023.npz'), data=data, mean=scaler.mean, std=scaler.std)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--moy', type=int, default=0, help='month of year')
